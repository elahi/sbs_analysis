...
childsA <- get_random_sizes(size_bin_vector = childs$length_mm, count_vector = childs$count_A, size_interval = 1)
childsB <- get_random_sizes(size_bin_vector = childs$length_mm, count_vector = childs$count_B, size_interval = 1)
childsC <- get_random_sizes(size_bin_vector = childs$length_mm, count_vector = childs$count_C, size_interval = 1)
childsD <- get_random_sizes(size_bin_vector = childs$length_mm, count_vector = childs$count_D, size_interval = 1)
...
waraB <- get_random_sizes(size_bin_vector = wara$length_mm, count_vector = wara$count_B, size_interval = 2)
waraD <- get_random_sizes(size_bin_vector = wara$length_mm, count_vector = wara$count_D, size_interval = 2)
