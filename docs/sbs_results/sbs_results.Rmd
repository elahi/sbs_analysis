...
Only maximum temperature displayed a positive trend over time for each species (P = 0.04 - 0.07). When the estimated rate (degrees per year) was multiplied by the duration of the regression, the estimated maximum temperature increases ranged from 0.54 - 0.65 C. Annual median and minimum temperatures did not change over time. 
