################################################################################
##' @title Run hierarchical intercept model - normal distribution
##'
##' @author Robin Elahi
...
source("sbs_bayes/model_hier1_normal.R")
...
write.csv(coda_quantile, "sbs_bayes/bayes_output/coda_quantile_hier1_normal_median.csv")
